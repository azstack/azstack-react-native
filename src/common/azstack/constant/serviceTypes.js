...
export const MESSAGE_NEW_WITH_USER_TYPE_STICKER = 104;
export const MESSAGE_HAS_NEW_WITH_USER_TYPE_STICKER = 104;
export const MESSAGE_HAS_NEW_WITH_USER_TYPE_FILE = 121;
